...
# 6. 问题反馈
新学期到了，有不少学弟学妹向我反映`UCAS-Helper`的使用问题，这让我很高兴，说明这个项目的确帮助到了人，
大家也乐意将自己的使用情况反馈给我，使这个项目更加完善。由于我本人目前主要在实验室，没有课程的需求，
因此只能不定期维护一下常用的几个功能，如课程资源下载，分数查询，教学评估。而校园网登录、登出，
账号破解由于需要校园网环境，因此基本无法做到更新。所以我希望有更多的人能够加入到这个开源项目中，
帮助完善、甚至开发新的功能到这个项目中，为果壳的同学们提供更多便利。下面是问题反馈的方式：
